...
from .icbhi_util_common import get_annotations, generate_fbank, get_individual_cycles_torchaudio, cut_pad_sample_torchaudio
from .augmentation import augment_raw_audio


class ICBHIDatasetPrev(Dataset):
    def __init__(self, train_flag, transform, args, print_flag=True, mean_std=False):
        ...
        if args.dataset == 'icbhi':
            cache_path = './data/training_icbhi_alone.pt' if self.train_flag else './data/test_icbhi_alone.pt'
        else:
        ...
        if not os.path.isfile(cache_path):
            ...
            if self.train_flag:
                ...
                if args.dataset == 'icbhi':
                    torch.save(self.audio_images, './data/training_icbhi_alone.pt')
                else:
                    torch.save(self.audio_images, './data/training_icbhi.pt')
            else:
                if args.dataset == 'icbhi':
                    torch.save(self.audio_images, './data/test_icbhi_alone.pt')
                else:
    ...
    def __getitem__(self, index):
        ...
        print('audio_images', len(audio_images))
        print('label', label)
