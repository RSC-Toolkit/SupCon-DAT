...
def save_model_multitask(model, optimizer, args, epoch, save_file, classifier1, classifier2):
    print('==> Saving...')
    state = {
        'args': args,
        'model': model.state_dict(),
        'optimizer': optimizer.state_dict(),
        'epoch': epoch,
        'lung_classifier': classifier1.state_dict(),
        'disease_classifier': classifier2.state_dict()        
    }

    torch.save(state, save_file)
    del state    

def save_model_multitask_soft(lung_model, disease_model, optimizer, args, epoch, save_file, classifier1, classifier2):
    print('==> Saving...')
    state = {
        'args': args,
        'lung_model': lung_model.state_dict(),
...
def save_model_multitask_soft_tri(lung_model, disease_model, domain_model, optimizer, args, epoch, save_file, classifier1, classifier2, classifier3):
    print('==> Saving...')
    state = {
        'args': args,
        'lung_model': lung_model.state_dict(),
        ...
        'lung_classifier': classifier1.state_dict(),
        'disease_classifier': classifier2.state_dict(),
        'domain_classifier': classifier3.state_dict()
    }

    torch.save(state, save_file)
    del state

def save_model_multitask_domain(model, optimizer, args, epoch, save_file, classifier1, classifier2, classifier3):
    print('==> Saving...')
    state = {
        'args': args,
        'model': model.state_dict(),
