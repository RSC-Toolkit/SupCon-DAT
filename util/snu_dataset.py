...
from .icbhi_util import get_annotations, generate_fbank, get_individual_cycles_torchaudio_snubh, cut_pad_sample_torchaudio, get_meta_infor
from .augmentation import augment_raw_audio


class SNUBHDataset(Dataset):
    def __init__(self, train_flag, transform, args, print_flag=True, mean_std=False):
        ...
        if args.multitask:
            if self.train_flag and os.path.isfile('./data/training_snubh_mtl_lung_class_nums.pt') and os.path.isfile('./data/training_snubh_mtl_disease_class_nums.pt'):
                self.lung_class_nums = torch.load('./data/training_snubh_mtl_lung_class_nums.pt')
                self.disease_class_nums = torch.load('./data/training_snubh_mtl_disease_class_nums.pt')
            cache_path = './data/training_snubh_mtl.pt' if self.train_flag else './data/test_snubh_mtl.pt'        
        elif args.multitask_domain:
            if self.train_flag and os.path.isfile('./data/training_snubh_mtld_lung_class_nums.pt') and os.path.isfile('./data/training_snubh_mtld_disease_class_nums.pt'):
                self.lung_class_nums = torch.load('./data/training_snubh_mtld_lung_class_nums.pt')
                self.disease_class_nums = torch.load('./data/training_snubh_mtld_disease_class_nums.pt')
            cache_path = './data/training_snubh_mtld.pt' if self.train_flag else './data/test_snubh_mtld.pt'        
        else:        
            ...
            cache_path = './data/training_snubh.pt' if self.train_flag else './data/test_snubh.pt'
        ...
        if not os.path.isfile(cache_path):
            ...
            if args.multitask:
                ...
                if self.train_flag:
                    lung_class_nums_cache_path = './data/training_snubh_mtl_lung_class_nums.pt'
                    disease_class_nums_cache_path = './data/training_snubh_mtl_disease_class_nums.pt'
                ...
                # ==========================================================================
                if self.train_flag:
                    torch.save(self.audio_images, './data/training_snubh_mtl.pt')
                else:
                    torch.save(self.audio_images, './data/test_snubh_mtl.pt')
                ...
                if self.train_flag:
                    lung_class_nums_cache_path = './data/training_snubh_mtld_lung_class_nums.pt'
                    disease_class_nums_cache_path = './data/training_snubh_mtld_disease_class_nums.pt'
                    if not os.path.isfile(lung_class_nums_cache_path):
                        torch.save(self.lung_class_nums, lung_class_nums_cache_path)
                    if not os.path.isfile(disease_class_nums_cache_path):
                        torch.save(self.disease_class_nums, disease_class_nums_cache_path)
                ...
                # ==========================================================================
                if self.train_flag:
                    torch.save(self.audio_images, './data/training_snubh_mtld.pt')
                else:
                    torch.save(self.audio_images, './data/test_snubh_mtld.pt')
            ...
            ##
                ...
                # ==========================================================================
                if self.train_flag:
                    torch.save(self.audio_images, './data/training_snubh.pt')
                else:
                    torch.save(self.audio_images, './data/test_snubh.pt')
            
        else:
            if args.multitask:
                if self.train_flag:
                    self.audio_images = torch.load('./data/training_snubh_mtl.pt')
                    self.lung_class_nums = torch.load('./data/training_snubh_mtl_lung_class_nums.pt')
                    self.disease_class_nums = torch.load('./data/training_snubh_mtl_disease_class_nums.pt')
                else:
                    self.audio_images = torch.load('./data/test_snubh_mtl.pt')
            
            elif args.multitask_domain:
                if self.train_flag:
                    self.audio_images = torch.load('./data/training_snubh_mtld.pt')
                    self.lung_class_nums = torch.load('./data/training_snubh_mtld_lung_class_nums.pt')
                    self.disease_class_nums = torch.load('./data/training_snubh_mtld_disease_class_nums.pt')
                else:
                    self.audio_images = torch.load('./data/test_snubh_mtld.pt')
            
            else:
                if self.train_flag:
                    self.audio_images = torch.load('./data/training_snubh.pt')
                    self.class_nums = torch.load('./data/training_snubh_class_nums.pt')
                else:
                    self.audio_images = torch.load('./data/test_snubh.pt')
